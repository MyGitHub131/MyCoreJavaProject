...
public class UniversityTesting13 {
	public static void main(String[] args) {
		Set<University> u = new TreeSet<University>(new SortingByUniversityIdComparator());
		...
		for (University university : u) {
			System.out.println(university.id + "=======" + university.name + "=======" + university.branches);
		}
	}
}				