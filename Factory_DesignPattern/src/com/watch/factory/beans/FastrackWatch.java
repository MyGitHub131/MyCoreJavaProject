...
public class FastrackWatch implements ISmartWatch {

	@Override
	public void start() {
		System.out.println("@@***FastrackWatch Details***@@");
		System.out.println("-------------------------------");
		System.out.println("FastrackWatch is started !!");
	...
	@Override
	public void stop() {
		System.out.println("FastrackWatch has stopped !!");
