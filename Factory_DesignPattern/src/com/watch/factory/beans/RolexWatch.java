...
public class RolexWatch implements ISmartWatch {

	@Override
	public void start() {
		System.out.println("@@***RolexWatch Details***@@");
		System.out.println("----------------------------");
		System.out.println("RolexWatch is started !!");
	...
	@Override
	public void stop() {
		System.out.println("RolexWatch has stopped !!");
